...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create_user(username='usuario_a',email='usuario_a@example.com', password='password123')
        self.usuario_b = User.objects.create_user(username='usuario_b',email='usuario_b@example.com', password='password123')
        self.usuario_c = User.objects.create_user(username='usuario_c',email='usuario_c@example.com', password='password123')
